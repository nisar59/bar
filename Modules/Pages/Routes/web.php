...
|
*/
Route::group(['prefix'=>'admin/pages','middleware' => ['permission:pages.view']],function(){
   Route::get('/', 'PagesController@index');
});

Route::group(['prefix'=>'admin/pages','middleware' => ['permission:pages.add']],function(){
...
Route::group(['prefix'=>'admin/pages','middleware' => ['permission:pages.delete']],function(){
