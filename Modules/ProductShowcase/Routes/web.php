...
Route::group(['prefix'=>'admin/product-showcase','middleware' => ['permission:product-showcase.view']],function(){
   Route::get('/', 'ProductShowcaseController@index');
});

Route::group(['prefix'=>'admin/product-showcase','middleware' => ['permission:product-showcase.add']],function(){
     Route::get('create', 'ProductShowcaseController@create');
    Route::post('store', 'ProductShowcaseController@store');

});
Route::group(['prefix'=>'admin/product-showcase','middleware' => ['permission:product-showcase.edit']],function(){
...
Route::group(['prefix'=>'admin/product-showcase','middleware' => ['permission:product-showcase.delete']],function(){
