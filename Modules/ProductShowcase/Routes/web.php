...
Route::group(['prefix'=>'admin/show-case','middleware' => ['permission:show-case.view']],function(){
   Route::get('/', 'ProductShowcaseController@index');
});

Route::group(['prefix'=>'admin/show-case','middleware' => ['permission:show-case.add']],function(){
     Route::get('create', 'ProductShowcaseController@create');
    Route::post('store', 'ProductShowcaseController@store');

});
Route::group(['prefix'=>'admin/show-case','middleware' => ['permission:show-case.edit']],function(){
...
Route::group(['prefix'=>'admin/show-case','middleware' => ['permission:show-case.delete']],function(){
