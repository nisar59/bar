  ...
  <div class="row align-items-center">
    <div class="col-md-8">
      ...
      <ol class="breadcrumb m-0">
        ...
        <li class="breadcrumb-item active">Sittings</li>
      </ol>
    </div>
  </div>
</div>
  ...
  <div class="col-12">
    <div class="card card-primary">
      <div class="card-header bg-white">
        <div class="row">
          <h4 class="col-md-6">Sittings</h4>
          <div class="col-md-6 text-end">
            <a href="{{url('admin/sittings/create')}}" class="btn btn-success">+</a>
          </div>
        </div>
      </div>
      <div class="card-body">
